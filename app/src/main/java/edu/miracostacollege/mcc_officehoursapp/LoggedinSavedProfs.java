...
public class LoggedinSavedProfs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addSavedInstructor(2);
        db.addSavedInstructor(3);
        instructorList = db.getAllSavedInstructors();
        instructorListAdapter = new SavedInstructorListAdapter(this, R.layout.activity_professor_list_item, instructorList);
